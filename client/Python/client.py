...
from .languages import c_lang_config, cpp_lang_config, java_lang_config, c_lang_spj_config, c_lang_spj_compile, py2_lang_config, py3_lang_config, pypy3_lang_config, go_lang_config, php_lang_config, js_lang_config
...
rl.on('line', (input) => {
  ...
  console.log(a + b);
    ...
    print("pypy3_judge")
    print(client.judge(src=pypy3_src, language_config=pypy3_lang_config,
                       max_cpu_time=1000, max_memory=128 * 1024 * 1024,
                       test_case_id="normal", output=True), "\n\n")
